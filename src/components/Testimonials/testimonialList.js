export default [
  ...
  {
    testimonial:`I had the pleasure working with Carl the past three years from recruiting and now being a student athlete at CSULA.
     He demonstrates and excels on and off the field with his leadership. Carl has been a first-class teammate, but also one of the most
     committed players on the team. He will provide so much energy and positivity in a work environment. All required assignment and responsibilities
     are 100% accurate and if he is uncertain he will ask questions.`,
    name:'Michael Erush',
    title:"CSULA Men's Soccer Assistant Coach"
  },
]
